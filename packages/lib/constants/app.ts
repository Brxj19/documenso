...
export const INTEGRATION_API_V1_REMINDER_MIN_INTERVAL_SECONDS = () =>
  Number(env('INTEGRATION_API_V1_REMINDER_MIN_INTERVAL_SECONDS') ?? '3600');

export const INTEGRATION_API_V1_REMINDER_MAX_PER_DAY = () =>
  Number(env('INTEGRATION_API_V1_REMINDER_MAX_PER_DAY') ?? '5');

export const INTEGRATION_API_V1_REMINDER_MAX_PER_REQUEST = () =>
  Number(env('INTEGRATION_API_V1_REMINDER_MAX_PER_REQUEST') ?? '15');

export const INTEGRATION_API_V1_REMINDER_ENABLED = () => env('INTEGRATION_API_V1_REMINDER_ENABLED') === 'true';
