declare namespace NodeJS {
  export interface ProcessEnv {
    ...
    INTEGRATION_API_V1_RETURN_URL_ALLOWLIST?: string;
    INTEGRATION_API_V1_CALLBACK_URL_ALLOWLIST?: string;
    INTEGRATION_API_V1_CALLBACK_SIGNING_SECRET?: string;
    INTEGRATION_API_V1_CALLBACK_TIMEOUT_MS?: string;
    INTEGRATION_API_V1_CALLBACK_MAX_ATTEMPTS?: string;
    INTEGRATION_API_V1_CALLBACK_RETRY_DELAY_MS?: string;
